...
from yt_dlp import YoutubeDL  # Switched to yt-dlp for active maintenance and better compatibility
...
async def callback_query_ytdl_audio(_, callback_query):
    try:
        ...
        ydl_opts = {
            ...
            "writethumbnail": True,
            'cookiefile': 'cookies.txt',  # Added to bypass YouTube restrictions
        }
